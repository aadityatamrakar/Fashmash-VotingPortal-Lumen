...
(function($) {
     ...
     **/
    var launch = new Date(2017, 0, 27, 18, 30);
    /**
     * The script
     **/
    var message = $('#message');
    ...
    function setDate(){
        ...
        message.html('Voting page is coming soon.<br/>Developed by <a style="color: white;" href="https://www.facebook.com/aaditya.tamrakar.9">Aaditya Tamrakar</a>');
